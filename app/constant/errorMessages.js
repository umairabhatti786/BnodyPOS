...
const GetCounterMessage = (strCaption, str) => {
  ...
  switch (strCaption) {
    ...
    case "noItemUnableHold":
      message = str._238
        ? str_238
        : "Cannot process to Freez ,Record not found";
      break;
    ...
    case "PostSettingTaxorDiscounttoRemove":
      message = str?._242
        ? str._242
        : "Bill cannot be post due to internet or server issue,Try again";
      break;
    ...
    case "OfflineCounterNotAuthorizedMessage":
      message = str?._276
        ? str._276
        : "Authentication failed! You need to login again";
    case "Unauthorized":
      message = strCaption?._276
        ? strCaption._276
        : "Authentication failed! You need to login again";
      break;
    case "BuyerNotAdded":
...
const GetCustomerMessage = (strCaption, str) => {
  ...
  switch (strCaption) {
    ...
    case "ExceedsRedeemPoints":
      message = str._415
        ? str._415
        : "Redeem Points cannot be greater than Balance points";
      break;
