...
const CirCleTableStyle = (props) => {
  ...
  const [orderType, setOrderType] = useState({ id: 1, value: "Dine In" });
...
const styles = StyleSheet.create({
  ...
  centerContainer: {
    ...
    width: sizeHelper.calHp(141),
    borderRadius: sizeHelper.calHp(141) / 2,
    alignItems: "center",
    justifyContent: "center",
...
export default CirCleTableStyle;
