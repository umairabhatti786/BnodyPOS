...
const LoyaltyCard = props => {
  ...
  useEffect(async () => {
    ...
    if (props.buyerInfo) {
      ...
      if (props.buyerInfo.LoyaltyCard !== null) {
        let info = {
          LoyaltyName: props.buyerInfo?.LoyaltyCard ? props.buyerInfo.LoyaltyCard.LoyaltyName : "",
          BuyerCode: props.buyerInfo?.LoyaltyCard ? props.buyerInfo.LoyaltyCard.BuyerCode : "",
          BuyerName: props.buyerInfo?.LoyaltyCard ? props.buyerInfo.LoyaltyCard.ClientName : "",
          RegistrationDate: "",
          Phone: props.buyerInfo?.LoyaltyCard ? props.buyerInfo.LoyaltyCard.Phone : "",
          Email: props.buyerInfo?.LoyaltyCard ? props.buyerInfo.LoyaltyCard.Email : "",
          RedeemPoints: props.buyerInfo?.LoyaltyCard ? String(props.buyerInfo.LoyaltyCard.RedeemPoints) : 0,
          BalancePoints: props.buyerInfo?.LoyaltyCard ? String(props.buyerInfo.LoyaltyCard.TotalPoints - props.buyerInfo.LoyaltyCard.RedeemPoints) : 0,
          Country: props.buyerInfo?.LoyaltyCard ? props.buyerInfo.LoyaltyCard.CountryName : ""
        }
  ...
  const redeemPointsFun = () => {
    ...
    if (redeemText !== 0 && props.buyerInfo?.LoyaltyCard) {
      if (Number(redeemText) <= Number(props.buyerInfo?.LoyaltyCard.TotalPoints - props.buyerInfo.LoyaltyCard.RedeemPoints)) {
        props.setRedeemPoints(Number(redeemText))
        props.cancel('loyaltyCard')
      } else {
        let msg = errorMessages.GetCustomerMessage("ExceedsRedeemPoints", props.StringsList);
