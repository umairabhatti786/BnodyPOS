...
export const ProductCardAddOnGroupListTable = 'ProductCardAddOnGroupList';

export const ProductCardAddOnGroupListCoulumnskey = {
  Id: 'Id',
...
export const ProductCardAddOnGroupListCreateTableCoulumns =
  `Id TEXT  PRIMARY KEY NOT NULL, AddOnGroupCode  TEXT, AddOnGroupDetailCode FLOAT, ProductCode  TEXT, ProductBarCode  TEXT, ProductType BOOLEAN, ` +
...
export const ProductCardAddOnGroupListInsertCoulumns =
  `Id, AddOnGroupCode, AddOnGroupDetailCode, ProductCode, ProductBarCode, ProductType, Name, ` +
  `Name2, UOMCode, UOMName, UOMName2, Price, Quantity, HoldFromSale, SaleTaxGroupCode, MediaContentType, MediaContents, Operation`;

export const InsertProductCardAddOnGroupList = async values => {
  let InsertDataQuery = `INSERT INTO ${ProductCardAddOnGroupListTable} (${ProductCardAddOnGroupListInsertCoulumns}) VALUES`;
  ...
  let InsertProductCardAddOnGroupList = await ExecuteQuery(InsertDataQuery, []);
  //   console.log('Insert Product Details..', InsertProductCardAddOnGroupList);
};
