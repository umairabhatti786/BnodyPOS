...
package com.bnodyrestaurantpos.utils;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    textSetting.setDoubleHeight(SettingEnum.Enable);//double high
                    textSetting.setDoubleWidth(SettingEnum.Enable);//double width
                    textSetting.setItalic(SettingEnum.Disable);//Italics
                    textSetting.setIsEscSmallCharactor(SettingEnum.Disable);//small font

                    escCmd.append(escCmd.getTextCmd(textSetting, "The Red Rose"));
                    escCmd.append(escCmd.getLFCRCmd());//carriage return line feed
                    textSetting.setBold(SettingEnum.Disable);
                    textSetting.setDoubleHeight(SettingEnum.Disable);//double hight
                    textSetting.setDoubleWidth(SettingEnum.Disable);//double width
                    textSetting.setIsEscSmallCharactor(SettingEnum.Enable);//small font
