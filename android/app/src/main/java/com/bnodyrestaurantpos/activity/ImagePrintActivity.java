...
import com.bnodyrestaurantpos.utils.SaveMediaFileUtil;
import com.bnodyrestaurantpos.utils.ToastUtil;
import com.bnodyrestaurantpos.view.BasicListDialog;
...
public class ImagePrintActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.print:
                try {
//                    if(rtPrinter!=null)rtPrinter.writeMsg(Pn10CompressPicUtils.getInstance().getEscNvCmdPrint());
//                    Log.i("rongtaPrint", "bitmapToArray: " + Pn10CompressPicUtils.picBytes2Hex(Pn10CompressPicUtils.getInstance().getEscNvCmdPrint()));
                    print();
...
//                if (mBitmap.getWidth() > 72 * 8) {//ZAC用户打印110无法满屏的问题添加
//                    mBitmap = BitmapConvertUtil.decodeSampledBitmapFromUri(ImagePrintActivity.this, uri, 110 * 8, 4000);
//                }else {
...
//                }
    ...
    ArrayList<byte[]> dotArrayList = new ArrayList<>();
